...
Revision ID: c367146a0244
Revises: 010_design_doc_path
Create Date: 2025-12-20 22:41:52.446988
...
revision = 'c367146a0244'
down_revision = '010_design_doc_path'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('agent_tasks', sa.Column('design_doc_path', sa.String(length=500), nullable=True))
...
def downgrade() -> None:
    ...
    op.alter_column('audit_issues', 'status',
               ...
               nullable=False,
               existing_server_default=sa.text("'open'::character varying"))
    op.add_column('agent_tasks', sa.Column('files_with_findings', sa.INTEGER(), autoincrement=False, nullable=True))
    ...
    op.drop_column('agent_tasks', 'design_doc_path')
    # ### end Alembic commands ###
